...
class Radarr(object):
  def __init__(self):
    ...
    htpc.MODULES.append({
      ...
      'fields': [
        ...
        {'type': 'text', 'label': 'Port', 'placeholder': '8989', 'name': 'radarr_port'},
  ...
  @require()
  def index(self):
    return htpc.LOOKUP.get_template('radarr.html').render(scriptname='radarr', webinterface=self.webinterface(),
                                                          quality=self.Profile())
